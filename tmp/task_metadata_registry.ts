...
export const TASK_METADATA_REGISTRY: Record<string, TaskMetadata> = {
  'task_manager:delete_inactive_background_task_nodes': { ownerPlugin: 'unknown', title: 'Remove inactive background task nodes' },
  'task_manager:invalidate_api_keys': { ownerPlugin: 'unknown', title: 'Invalidate task manager API keys' },
  'task_manager:mark_removed_tasks_as_unrecognized': { ownerPlugin: 'unknown', title: 'Mark removed tasks as unrecognized' },
  'SampleDataIngest:InstallSampleData': { ownerPlugin: 'sample_data_ingest', title: 'Install sample data SampleDataIngest:InstallSampleData' },
  ...
  'ProductDocBase:InstallAll': { ownerPlugin: 'ai_infra', title: 'Install all product documentation artifacts ProductDocBase:InstallAll' },
  'ProductDocBase:UninstallAll': { ownerPlugin: 'ai_infra', title: 'Uninstall all product documentation artifacts ProductDocBase:UninstallAll' },
  ...
  'ML:saved-objects-sync': { ownerPlugin: 'ml', title: 'ML saved objet sync' },
  ...
  'alerting:security.attack_discovery.data_generator': { ownerPlugin: 'alerting', title: 'Attack Discovery Data Generator (dev-only)' },
  ...
  'streams_description_generation': { ownerPlugin: 'streams', title: 'N/A' },
  'streams_systems_identification': { ownerPlugin: 'streams', title: 'N/A' },
  'streams_significant_events_queries_generation': { ownerPlugin: 'streams', title: 'N/A' },
  'streams_features_identification': { ownerPlugin: 'streams', title: 'N/A' },
  'streams_insights_discovery': { ownerPlugin: 'streams', title: 'N/A' },
